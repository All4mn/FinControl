...
const features = [
  {
    ...
    description:
      "Visualize seu desempenho financeiro mes a mes com graficos coloridos e faceis de entender.",
  },
  {
    icon: Icons.PieChart,
    title: "Categorias de Gastos",
    description:
      "Organize suas despesas por categorias como Alimentacao, Transporte, Lazer e muito mais.",
  },
  {
    icon: Icons.Calendar,
    title: "Historico Completo",
    description:
      "Acompanhe todas as suas transacoes com datas, valores e descricoes detalhadas.",
  },
  {
    icon: Icons.Shield,
    title: "Seguranca de Dados",
    description:
      "Seus dados financeiros sao protegidos com criptografia e login seguro.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Compartilhe o controle financeiro com familiares ou parceiros de forma pratica.",
  },
];
...
const steps = [
  ...
  {
    number: "02",
    title: "Adicione suas transacoes",
    description:
      "Registre suas receitas e despesas de forma simples, escolhendo categoria e metodo de pagamento.",
  },
  {
    number: "03",
    title: "Acompanhe seus relatorios",
    description:
      "Visualize graficos e relatorios mensais para entender para onde seu dinheiro esta indo.",
  },
];

const includedFeatures = [
  "Registro ilimitado de transacoes",
...
// ===================================
// Recebemos a prop "aoClicarEntrar" para fazer a troca de página
      ...
      <header className={styles.header}>
        <div className={styles.headerContainer}>
          ...
          <div className={styles.headerButtons}>
            {/* Botão do Header chamando a prop aoClicarEntrar */}
            <button
            ...
            <button className={`${styles.button} ${styles.buttonPrimary}`} onClick={irParaCadastro}>
              Cadastre-se
            </button>
          </div>
          ...
          <div className={styles.mobileMenu}>
            <nav className={styles.mobileNav}>
              ...
              <div className={styles.mobileButtons}>
                {/* Botão Mobile chamando a prop aoClicarEntrar */}
                <button
          ...
          <div className={styles.heroGrid}>
            <div className={styles.heroContent}>
              ...
              <h1 className={styles.heroTitle}>
                Controle suas financas de forma{" "}
                <span className={styles.highlight}>simples e inteligente</span>
              </h1>

              <p className={styles.heroDescription}>
                O FinControl ajuda voce a organizar suas receitas e despesas,
                visualizar relatorios mensais e tomar decisoes financeiras mais
            ...
            <div className={styles.heroImageWrapper}>
              <div className={styles.heroImage}>
                <img
                  ...
                  alt="Dashboard do FinControl mostrando saldo e transacoes"
                />
              </div>
        ...
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>
              ...
              <span className={styles.highlight}>organizar suas financas</span>
            </h2>
            <p className={styles.sectionDescription}>
              Ferramentas simples e poderosas para ajudar voce a ter controle
      ...
      <section id="como-funciona" className={styles.howItWorks}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDescription}>
              Tres passos simples para voce comecar a controlar suas financas
              hoje mesmo.
            </p>
          </div>
      ...
      <section id="sobre" className={styles.about}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDescription}>
              Conheca a historia por tras do projeto e quem esta desenvolvendo
              esta ferramenta.
            </p>
          </div>
          ...
          <div className={styles.aboutContent}>
              ...
              <div className={styles.creatorContent}>
                ...
                <div className={styles.creatorText}>
                  ...
                  <p className={styles.creatorDescription}>
                    O FinControl e um projeto desenvolvido com o objetivo de
                    ajudar pessoas a terem mais controle sobre suas financas
                    pessoais. Nasceu da necessidade de uma ferramenta simples e
                    acessivel que qualquer pessoa pudesse usar, independente da
                    idade ou conhecimento tecnico.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={styles.valuesGrid}>
              <div className={styles.valueCard}>
                ...
                <h3 className={styles.valueTitle}>Nossa Missao</h3>
                <p className={styles.valueDescription}>
                  Democratizar o acesso a ferramentas de controle financeiro,
                  permitindo que qualquer pessoa possa organizar suas financas
              ...
              <div className={styles.valueCard}>
                ...
                <p className={styles.valueDescription}>
                  Acreditamos na simplicidade, acessibilidade e transparencia. O
                  FinControl foi pensado para ser intuitivo para todas as
                  idades, desde jovens ate idosos.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="preco" className={styles.pricing}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>
              Quanto custa o{" "}
              <span className={styles.highlight}>FinControl</span>?
            </h2>
            <p className={styles.sectionDescription}>
              Boas noticias: o FinControl e completamente gratuito! Acreditamos
              que todos merecem ter controle sobre suas financas.
            </p>
          </div>
          ...
          <div className={styles.pricingCard}>
            ...
            <div className={styles.pricingHeader}>
              ...
              <p className={styles.priceSubtext}>
                Sem taxas ocultas, sem periodo de teste
              </p>
            </div>
            ...
            <div className={styles.pricingContent}>
              ...
              <button
                className={`${styles.button} ${styles.buttonPrimary} ${styles.buttonLarge} ${styles.pricingButton}`} onClick={irParaCadastro}
              >
          ...
          <div className={styles.trustSection}>
            <p className={styles.trustTitle}>Por que e gratuito?</p>
            <p className={styles.trustDescription}>
              O FinControl foi criado como um projeto para ajudar pessoas a
              terem mais controle sobre suas financas pessoais. Nosso objetivo e
              democratizar o acesso a ferramentas de gestao financeira.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className={styles.container}>
          <div className={styles.ctaContent}>
            ...
            <p className={styles.ctaDescription}>
              Junte-se a milhares de pessoas que ja estao usando o FinControl
              para organizar suas financas. Cadastro rapido e totalmente
              gratuito.
            </p>
          ...
          <div className={styles.footerGrid}>
            <div className={styles.footerBrand}>
              ...
              <p className={styles.footerDescription}>
                O FinControl e uma ferramenta gratuita de controle financeiro
                pessoal, criada para ajudar pessoas de todas as idades a
                organizarem suas financas.
              </p>
            </div>
